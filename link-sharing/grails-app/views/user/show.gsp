	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<li class="fieldcontain">
					<span id="dateofbirth-label" class="property-label"><g:message code="user.dateofbirth.label" default="Dateofbirth" /></span>
				...
				<g:if test="${userInstance?.reading}">
				<li class="fieldcontain">
					<span id="reading-label" class="property-label"><g:message code="user.reading.label" default="Reading" /></span>
					
						<g:each in="${userInstance.reading}" var="r">
						<span class="property-value" aria-labelledby="reading-label"><g:link controller="readingItem" action="show" id="${r.id}">${r?.encodeAsHTML()}</g:link></span>
						</g:each>
